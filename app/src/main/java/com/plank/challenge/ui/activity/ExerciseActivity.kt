...
import com.plank.challenge.model.Exercises
import com.plank.challenge.ui.adapter.ExerciseStatusAdapter
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exerciseTime = when {
            appPreferences.getLevel() == 1 -> 30
            appPreferences.getLevel() == 2 -> 60
            else -> 120
        }
    ...
    private fun setupExerciseStatusRecyclerView() {
        ...
        exercise_status_rv.layoutManager = LinearLayoutManager(
            this,
